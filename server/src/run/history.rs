//! Terminates disposable compaction history with a user instruction.
...
/// This helper is only for compaction requests, which explicitly reset the
/// prefix. Normal continuations must be committed before provider dispatch.
