...
const AUTHOR_REPOSITORY_URL = "https://github.com/Galaxy-A/cursor-byok";
const AUTHOR_LABEL = "@Galaxy-A"
const AUTHOR_DISCLAIMER = "基于 leookun/cursor-byok fork 并定制。本项目是非官方社区项目，与 Anysphere 或 Cursor 官方不存在隶属、赞助或背书关系。Cursor 名称及相关商标归其权利人所有。";
  ...
  <div class="flex h-screen w-screen overflow-hidden flex-col">
    ...
    >
      ...
      <button
        type="button"
        class="center-row shrink-0 gap-[6px] cursor-pointer rounded-[6px] px-[6px] py-[3px] transition-colors duration-150 hover:bg-[#1f1f1f] hover:text-[#e5e5e5]"
        @click="handleOpenAuthorHome" :title="AUTHOR_DISCLAIMER"
      >
