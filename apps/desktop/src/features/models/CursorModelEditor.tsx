...
export function CursorModelEditor({ draft, modelOptions, discovering, onChange, onDiscover }: {
    ...
    onChange({
      ...
      model: {
        ...
        openai_endpoint: type === "openai"
          ? draft.model.codex_outbound_enabled ? "/v1/responses" : (endpoint?.openaiEndpoint || draft.model.openai_endpoint || "/v1/responses")
          : "",
        codex_outbound_enabled: type === "openai" && draft.model.codex_outbound_enabled,
  ...
  const applyPreset = (preset: ModelPreset) => {
    ...
    onChange({
      ...
      model: {
        ...
        base_url: endpoint.baseUrl,
        use_full_url: endpoint.useFullUrl,
        openai_endpoint: draft.model.type === "openai"
          ? draft.model.codex_outbound_enabled ? "/v1/responses" : endpoint.openaiEndpoint
          : draft.model.openai_endpoint,
        custom_headers_enabled: endpoint.customHeaders !== null,
        custom_headers: endpoint.customHeaders ? { ...endpoint.customHeaders } : {},
  ...
  return <div className={styles.editor}>
    ...
    <div className={styles.grid}>
      ...
      {draft.model.type === "openai" && <FormField className={styles.fullWidth} label={t("启用 Codex 出站协议")}>
        <Switch
